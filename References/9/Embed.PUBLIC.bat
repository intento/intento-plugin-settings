...
echo --- ilmerge ---
echo ilmerge\ilmerge /targetplatform:v4 /out:Merged\MemoQ.IntentoMT.dll bin\Intento.MemoQMTPlugin.dll bin\Intento.MT.Plugin.PropertiesForm.dll bin\Intento.SDK.dll bin\Intento.SDK.Autofac.dll bin\Autofac.dll bin\AWSSDK.S3.dll bin\AWSSDK.Core.dll bin\UrlCombineLib.dll
ilmerge\ilmerge /targetplatform:v4 /out:Merged\MemoQ.IntentoMT.dll bin\Intento.MemoQMTPlugin.dll bin\Intento.MT.Plugin.PropertiesForm.dll bin\Intento.SDK.dll bin\Intento.SDK.Autofac.dll bin\Autofac.dll bin\AWSSDK.S3.dll bin\AWSSDK.Core.dll bin\UrlCombineLib.dll 
